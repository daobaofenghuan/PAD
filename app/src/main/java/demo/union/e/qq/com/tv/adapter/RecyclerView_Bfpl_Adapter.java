...
public class RecyclerView_Bfpl_Adapter extends RecyclerView.Adapter<RecyclerView_Bfpl_Adapter.MyView> implements View.OnClickListener {
    ...
    public void addll(List<String> dataBeans) {
//        list.clear();
    ...
    public RecyclerView_Bfpl_Adapter() {
    ...
    public MyView onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_device_f32, parent, false);
