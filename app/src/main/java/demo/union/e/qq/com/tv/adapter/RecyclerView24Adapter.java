...
public class RecyclerView24Adapter extends RecyclerView.Adapter<RecyclerView24Adapter.MyView> implements View.OnClickListener {

    public List<Details_24.DataBean> getList() {
        return list;
    }

    public void setList(List<Details_24.DataBean> list) {
        this.list = list;
    }

    private List<Details_24.DataBean> list = new ArrayList<>();
    ...
    public void addll(List<Details_24.DataBean> dataBeans) {
    ...
    public MyView onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_device_head3, parent, false);
