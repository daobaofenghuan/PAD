...
public class DevicesHead_Adapter extends CommonRecyclerViewAdapter<ItemBean> {
    private boolean isV7;

    public DevicesHead_Adapter(Context context, boolean isV7) {
        super(context);
        this.isV7 = isV7;
    }
    ...
    public int getItemLayoutId(int viewType) {
        return R.layout.item_device_head;
    }
